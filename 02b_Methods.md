...
14. (24Feb2021) Re-run PPanGGOLiN with new gbk files generated by prokka. Moved old copy of `Ecoli_K12_MG1655.gbk` to `/project/kmou/FS19C/polished_genomes_100X/referencegenomes/`. Copied gbk files from 95 isolates + 6 reference genomes *_pol/ to `/project/kmou/FS19C/polished_genomes_100X/polishedgenomesprokka_95isolates6refgenomes/prokka_gbk` directory.
```
find . -name *.gbk -exec cp '{}' "./prokka_gbk/" ";"
```
